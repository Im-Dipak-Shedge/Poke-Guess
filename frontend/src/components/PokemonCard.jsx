...
//   // Podium card styling per place — colors, medal, badge
//   const podiumStyle = {
//     1: {
//       box: `
//       bg-white
...
//       medal: "#1",
//       badge: "CHAMPION",
//       badgeClass: "bg-[#E53935]",
//       nameColor: "text-[#1F4E8C]",
//       flex: "flex-[1.15]",
//       maxW: "max-w-[95px] lg:max-w-[190px]",
//     },
...
//       nameColor: "text-[#1F4E8C]",
//       flex: "flex-1",
//       maxW: "max-w-[85px] lg:max-w-[165px]",
//     },
...
//           style={{
//             background:
//               "linear-gradient(180deg,#6EC6FF 0%,#8FD8FF 35%,#BDEBFF 65%,#7ED957 100%)",
//           }}
//         >
//           <div className="absolute inset-0 bg-black/15" />

//           {/* Decorative pokeballs, subtle and out of the way */}
//           <Pokeball className="pointer-events-none absolute top-1 left-1 w-6 h-6 lg:w-9 lg:h-9 opacity-25" />
//           <Pokeball className="pointer-events-none absolute bottom-1 right-1 w-6 h-6 lg:w-9 lg:h-9 opacity-25" />

//           <div className="relative z-10 h-full w-full flex flex-col p-1.5 lg:p-4">
//             {/* Slim one-line header — no giant emoji/title eating vertical space */}
//             <div className="shrink-0 flex items-center justify-center gap-1.5 pb-1 lg:pb-3">
//               <span className="text-sm lg:text-2xl leading-none">🏆</span>
//               <h2
//                 className="text-xs lg:text-2xl font-black text-yellow-300 uppercase tracking-wide truncate"
//                 style={{ textShadow: "0 2px 6px rgba(0,0,0,.5)" }}
//               >
//                 {winner ? `${winner} Wins!` : "Winners"}
//               </h2>
//             </div>

//             {/* Podium — takes essentially all remaining height, scales with the card */}
//             <div className="flex-1 min-h-0 flex items-end justify-center gap-1.5 lg:gap-6">
//               {[2, 1, 3].map((place) => {
...
//                   <div
//                     key={place}
//                     className={`h-full flex flex-col items-center justify-end ${style.flex} ${style.maxW} ${
//                       isFirst ? "z-10" : ""
//                     }`}
//                   >
//                     {/* Colored card: grows to fill available height, avatar scales inside it */}
//                     <div
//                       className={`w-full flex-1 min-h-0 rounded-2xl border-4 overflow-hidden ${style.box}`}
//                     >
//                       {/* Top strip */}
//                       <div
//                         className={`h-7 lg:h-10 flex items-center justify-center font-black text-white text-[10px] lg:text-lg ${style.top}`}
//                       >
//                         {style.medal}
//                       </div>
...
//                       {/* Name */}
//                       <div className="bg-[#F7F8FC] border-t px-1 py-2">
//                         <p
//                           className={`text-center font-black text-[9px] lg:text-base truncate ${style.nameColor}`}
//                         >
//                           {entry.trainerName}
//                         </p>

//                         <p className="text-center text-[8px] lg:text-sm text-gray-500 font-semibold">
...
//                           <span className="px-2 lg:px-4 py-1 rounded-full bg-[#E53935] text-white font-black text-[7px] lg:text-xs">
//                             CHAMPION
//                           </span>
//                         </div>
//                       )}
...
//                     <span className="mt-0.5 lg:mt-1.5 shrink-0 text-[7px] lg:text-xs font-bold text-yellow-100">
//                       {entry.points ?? entry.score ?? 0} pts
//                     </span>
//                   </div>
//                 );
